...
## Define a decorator to check for NaN or Inf in input data
...
def get_input_sample(sent_obj, tokenizer, eeg_type='GD', bands=['_t1', '_t2', '_a1', '_a2', '_b1', '_b2', '_g1', '_g2'],
    ...
    # TODO: Add tokenized result
    # NOTE: Text-only operation
    ...
    for task_name in task_names:
        ...
        for mat_file in tqdm(mat_files):
            ...
            for sent in matdata:
                ...
                if not isinstance(word_data, float):
                    ...
                    for word in word_data:
                        ...
                        # Handle case where nFixations might be an array
            ...
            for i in range(train_divider):#
                # 320 sentences per subject as training data
